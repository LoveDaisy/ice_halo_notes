...
from .scene import (annotate, draw_axes, draw_raypath, finish, new_figure, render_corridor,
                    render_crystal)
...
__all__ = [
    ...
    "finish", "new_figure", "parallel_origins", "render_corridor", "render_crystal", "rotation", "rotation_between",
