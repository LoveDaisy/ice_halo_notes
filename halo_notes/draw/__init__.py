...
from .geometry import Face, HexPrism, Polyhedron, rotation
from .projection import Camera, face_visible, visible_faces
from .raypath import Cone, RayPath, SegmentKind, trace
...
__all__ = [
    ...
    "SegmentKind", "draw_axes", "draw_raypath", "face_visible", "finish", "new_figure",
    "render_crystal", "rotation", "trace", "visible_faces",
]
