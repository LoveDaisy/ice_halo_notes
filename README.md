...
| 6 | `06-monte-carlo-vs-integration/` | [蒙特卡洛 vs. 直接积分](06-monte-carlo-vs-integration/数值积分.md) | published | [p/536772578](https://zhuanlan.zhihu.com/p/536772578) | `[[现代冰晕研究漫谈(6)： 蒙特卡洛 vs. 直接积分]]` |
